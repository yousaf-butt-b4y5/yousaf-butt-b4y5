...
**IT-Systemadministrator · local-first AI builder**

I keep IT running by day and build AI that runs on consumer hardware by night. Core belief: **useful AI doesn't need a datacenter — it needs good architecture.**

My path is *vom Betreuen ins Bauen* — from maintaining systems to building and automating them. Stations along the way: CANCOM, ING-DiBa, Bechtle. Today I'm an IT-Systemadministrator in the logistics world, bringing AI-native automation to everyday IT ops — Active Directory lifecycles, Microsoft 365, PowerShell, and the boring tickets nobody wants to touch.

## 🧭 What I'm building toward
A single, **local-first hub**: an Obsidian vault as long-term memory and a self-hosted AI workspace ([Odysseus](https://github.com/yousaf-butt-b4y5/odysseus)) as the brain — reachable from any tool through **MCP**. The long game is an AI-native IT admin who automates onboarding, ticket triage, and the daily grind end to end.
...
---
*Local-first. Built on consumer hardware. Shared in the open.*
